...
/**
 * Hover slideshow primitives (adapted from the shadcn "animated-slideshow"
 * block). Two adaptations for this codebase:
 *  - imports from `framer-motion` (the project standardizes on it) instead of
 *    the separate `motion` package, to avoid shipping two animation engines.
 *  - `useHoverSliderContext` is exported so consumers can render extra UI
 *    (captions, indicators) that react to the active slide.
 */
